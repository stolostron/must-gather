...
def clusterMemCapacity(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/cluster-mem-capacity.png')
        utility.saveCSV(node_cpu_trend_df,"cluster-mem-capacity",True)
        plt.close('all')
...
def clusterMemUsed(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/cluster-mem-usage.png')
        utility.saveCSV(node_cpu_trend_df,"cluster-mem-usage",True)
        plt.close('all')
...
def clusterMemPctUsed(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/cluster-mem-pct-usage.png')
        utility.saveCSV(node_cpu_trend_df,"cluster-mem-pct-usage",True)
        plt.close('all')
...
def nodeMemUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/node-mem-usage.png')
        utility.saveCSV(node_cpu_trend_df,"node-mem-usage")
        plt.close('all')
...
def kubeAPIMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/kubeapi-mem-usage-rss.png')
        utility.saveCSV(kubeapi_cpu_trend_df,"kubeapi-mem-usage-rss",True)
        plt.close('all')
...
def ACMMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-mem-usage-rss",True)
        plt.close('all')
...
def ACMDetailMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-detail-mem-usage-rss.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-detail-mem-usage-rss")
        plt.close('all')
...
def OtherMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/other-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"other-mem-usage-rss",True)
        plt.close('all')
...
def OtherDetailMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/other-detail-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"other-detail-mem-usage-rss")
        plt.close('all')
...
def kubeAPIMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/kubeapi-mem-usage-wss.png')
        utility.saveCSV(kubeapi_cpu_trend_df,"kubeapi-mem-usage-wss",True)
        plt.close('all')
...
def ACMMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-mem-usage-wss",True)
        plt.close('all')
...
def ACMDetailMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-detail-mem-usage-wss.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-detail-mem-usage-wss")
        plt.close('all')
...
def OtherMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        acm_cpu_trend_df.plot(title="Other Memory usage GB",figsize=(30, 15))
        plt.savefig(utility.inspector_dir + '/other-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"other-mem-usage-wss",True)
        plt.close('all')
...
def OtherDetailMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/other-detail-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"other-detail-mem-usage-wss")
        plt.close('all')
...
def ACMObsMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-obs-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-obs-mem-usage-rss",True)
        plt.close('all')
...
def ACMObsMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-obs-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-obs-mem-usage-wss",True)
        plt.close('all')
...
def ACMOtherMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-oth-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-oth-mem-usage-rss",True)
        plt.close('all')
...
def ACMOtherMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-oth-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-oth-mem-usage-wss",True)
        plt.close('all')
...
def ACMObsDetailMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-obs-detail-mem-usage-rss.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-obs-detail-mem-usage-rss")
        plt.close('all')
...
def ACMObsDetailMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-obs-detail-mem-usage-wss.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-obs-detail-mem-usage-wss")
        plt.close('all')
...
def ACMObsRecvMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-obs-recv-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-obs-recv-mem-usage-rss",True)
        plt.close('all')
...
def ACMObsRecvMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-obs-recv-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-obs-recv-mem-usage-wss",True)
        plt.close('all')
...
def ACMOCMDetailMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-ocm-detail-mem-usage-rss.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-ocm-detail-mem-usage-rss")
        plt.close('all')
...
def ACMOCMDetailMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-ocm-detail-mem-usage-wss.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-ocm-detail-mem-usage-wss")
        plt.close('all')
...
def ACMSrcPGvMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-src-pg-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-src-pg-mem-usage-rss",True)
        plt.close('all')
...
def ACMOSrcPGMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-src-pg-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-src-pg-mem-usage-wss",True)
        plt.close('all')
...
def ACMSrcIdxvMemUsageRSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-src-idx-mem-usage-rss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-src-idx-mem-usage-rss",True)
        plt.close('all')
...
def ACMOSrcIdxMemUsageWSS(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-src-idx-mem-usage-wss.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-src-idx-mem-usage-wss",True)
        plt.close('all')
