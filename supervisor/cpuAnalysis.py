...
def clusterCPUCoreCapacity(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/cluster-cpu-core-cap.png')
        utility.saveCSV(node_cpu_trend_df,"cluster-cpu-core-cap",True)
        plt.close('all')
...
def clusterCPUCoreUsed(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/cluster-cpu-core-usage.png')
        utility.saveCSV(node_cpu_trend_df,"cluster-cpu-core-usage",True)
        plt.close('all')
...
def clusterCPUPctUsed(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/cluster-cpu-pct-usage.png')
        utility.saveCSV(node_cpu_trend_df,"cluster-cpu-pct-usage",True)
        plt.close('all')
...
def clusterCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/cluster-cpu-usage.png')
        utility.saveCSV(node_cpu_trend_df,"cluster-cpu-usage",True)
        plt.close('all')
...
def nodeCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/node-cpu-usage.png')
        utility.saveCSV(node_cpu_trend_df,"node-cpu-usage")
        plt.close('all')
...
def kubeAPICPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/kubeapi-cpu-usage.png')
        utility.saveCSV(kubeapi_cpu_trend_df,"kubeapi-cpu-usage",True)
        plt.close('all')
...
def ACMCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-cpu-usage",True)
        plt.close('all')
...
def ACMDetailCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-detail-cpu-usage.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-detail-cpu-usage")
        plt.close('all')
...
def OtherCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/other-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"other-cpu-usage",True)
        plt.close('all')
...
def OtherDetailCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        acm_cpu_trend_df.rename(columns={"value": "OtherCPUCoreUsage"}, inplace = True)
        acm_cpu_trend_df.plot(title="Other CPU Core usage",figsize=(30, 15))
        plt.savefig(utility.inspector_dir + '/breakdown/other-detail-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"other-detail-cpu-usage")
        plt.close('all')
...
def ACMObsCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-obs-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-obs-cpu-usage",True)
        plt.close('all')
...
def ACMOtherCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-oth-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-oth-cpu-usage",True)
        plt.close('all')
...
def ACMObsDetailCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-obs-detail-cpu-usage.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-obs-detail-cpu-usage")
        plt.close('all')
...
def ACMObsRecvCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-obs-recv-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-obs-recv-cpu-usage",True)
        plt.close('all')
...
def ACMSrcPGCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-src-pg-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-src-pg-cpu-usage",True)
        plt.close('all')
...
def ACMSrcIdxCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/acm-src-idx-cpu-usage.png')
        utility.saveCSV(acm_cpu_trend_df,"acm-src-idx-cpu-usage",True)
        plt.close('all')
...
def ACMOCMDetailCPUUsage(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/acm-ocm-detail-cpu-usage.png')
        utility.saveCSV(acm_detail_cpu_trend_df,"acm-ocm-detail-cpu-usage")
        plt.close('all')
