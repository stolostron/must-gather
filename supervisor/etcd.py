...
def etcdBackendCommitDuration(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig('../../output/breakdown/etcd-backend-commit-duration-detail.png')
        saveCSV(etcd_data_trend_df,'etcd-backend-commit-duration-detail')
        plt.close('all')
        ...
        plt.savefig('../../output/etcd-backend-commit-duration.png')
        saveCSV(etcd_data_sum_trend_df,'etcd-backend-commit-duration',True)
        plt.close('all')
...
def etcdDiskWalsyncDuration(pc,startTime, endTime, step):
    ...
    try:
        ...
        etcd_data_trend_df =  etcd_data_trend_df.pivot( columns='instance',values='value')
        etcd_data_trend_df.plot(title="Etcd Backend Commit Duration 99th Percentile in seconds",figsize=(30, 15))
        plt.savefig('../../output/breakdown/etcd-wal-sync-duration-detail.png')
        saveCSV(etcd_data_trend_df,'etcd-wal-sync-duration-detail')
        plt.close('all')
        ...
        plt.savefig('../../output/etcd-wal-sync-duration.png')
        saveCSV(etcd_data_sum_trend_df,'etcd-wal-sync-duration',True)
        plt.close('all')
...
def etcdNetworkPeerRounTripDuration(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig('../../output/breakdown/etcd-network-peer-roundtrip-duration-detail.png')
        saveCSV(etcd_data_trend_df,'etcd-network-peer-roundtrip-duration-detail')
        plt.close('all')
        ...
        plt.savefig('../../output/etcd-network-peer-roundtrip-duration.png')
        saveCSV(etcd_data_sum_trend_df,'etcd-network-peer-roundtrip-duration',True)
        plt.close('all')
...
def etcdCPUIowaitDuration(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig('../../output/breakdown/etcd-cpu-iowait-duration-detail.png')
        saveCSV(etcd_data_trend_df,'etcd-cpu-iowait-duration-detail')
        plt.close('all')
        ...
        plt.savefig('../../output/etcd-cpu-iowait-duration.png')
        saveCSV(etcd_data_sum_trend_df,'etcd-cpu-iowait-duration',True)
        plt.close('all')
