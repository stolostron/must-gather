...
def thanosCompactToDo(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/thanos-compact-todo-compaction.png')
        utility.saveCSV(compactor_data_trend_df[['CompactorToDo']],'thanos-compact-todo-compaction',True)
        plt.close('all')
...
def thanosCompactHalt(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/thanos-compact-halted.png')
        utility.saveCSV(compactor_data_trend_df[['CompactorHalted']],'thanos-compact-halted',True)
        plt.close('all')
...
def thanosRecvSync90(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/thanos-recv-sync-90.png')
        utility.saveCSV(recvsync90_data_trend_df,'thanos-recv-sync-90',True)
        plt.close('all')
...
def thanosRecvSync95(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/thanos-recv-sync-95.png')
        utility.saveCSV(recvsync90_data_trend_df,'thanos-recv-sync-95',True)
        plt.close('all')
...
def thanosRecvSync99(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/thanos-recv-sync-99.png')
        utility.saveCSV(recvsync90_data_trend_df,'thanos-recv-sync-99',True)
        plt.close('all')
...
def thanosRecvGrpcError(pc,startTime, endTime, step):
    ...
    try:
        ...
        plt.savefig(utility.inspector_dir + '/breakdown/thanos-recv-grpc-error.png')
        utility.saveCSV(recvsync90_data_trend_df,'thanos-recv-grpc-error')
        plt.close('all')
